...
class TestPerson {
	...
	void test() {
		...
		list.deletePerson(new Person("556366", "Max", "Mustermann", "12345", "Straße", "1234", "Stadt",
		...
		assertEquals("556364", list.addNewPerson("556364", "Max", "Mustermann", "12345", "Straße", "1234", "Stadt",
				"Land", "12.34.5678", "12345678"));
		assertEquals("556368", list.addNewPerson("556368", "Max", "Mustermann", "12345", "Straße", "1234", "Stadt",
				"Land", "12.34.5678", "12345678"));
		list.listAllPersons();
		list.deletePerson(new Person("556363", "Max", "Mustermann", "12345", "Straße", "1234", "Stadt",
				"Land", "12.34.5678", "12345678"));
